...
x<-lapply(seq_along(beast_trees_list), function(trees_sample_index) {
  beast2tpPipeline:::prep_for_TransPhylo(beast_trees_list[[trees_sample_index]],
                 cluster_name = names(beast_trees_list)[trees_sample_index],
                 type = "trees_sample",
                 cluster_dict = all_cluster_assignments,
                 out_dir = system.file("tree_sample_example",
...
the package. The infector probabilities are saved in the specified `out_dir`.95_HPD
